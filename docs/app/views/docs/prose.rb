...
module Views
  module Docs
    ...
    # rhythm via Tailwind's arbitrary-variant child selectors (so it does not
    # depend on a specific typography plugin config). Authoring a doc is just
    # writing p/ul/h3/code inside.
    #
