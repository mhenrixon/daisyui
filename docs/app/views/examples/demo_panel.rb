...
module Views
  module Examples
    # The code-alongside panel for one live reactive demo, shown three ways in
    # CSS-only daisyUI tabs (no JS):
    ...
    class DemoPanel < Phlex::HTML
      ...
      # The component's own source file, read via its view_template location.
