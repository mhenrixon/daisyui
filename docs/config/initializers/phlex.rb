...
# as a host app would define them. The signed identity token carries the class
# name verbatim, so the demo's class name must match what a reader would write —
# CounterComponent, not Components::CounterComponent.
